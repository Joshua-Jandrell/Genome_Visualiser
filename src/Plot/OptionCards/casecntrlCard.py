...
class CasecntrlOptionCard(PlotOptionCard):
    def __init__(self, master, option_ctrl, option_key: str, option_value=None, width: int = 190, height: int = 70, corner_radius: int | str | None = 10, border_width: int | str | None = 1, bg_color: str | Tuple[str] = "transparent", fg_color: str | Tuple[str] | None = "#FFE4E1", border_color: str | Tuple[str] | None = "#DF4D55", background_corner_colors: Tuple[str | Tuple[str]] | None = ("#A80003", "#A80003", "#A80003", "#A80003"), overwrite_preferred_drawing_method: str | None = None, **kwargs):

...
class ZygoOptionCard(PlotOptionCard):
    ...
    def __init__(self, master, option_ctrl, option_key: str, option_value=None, width: int = 200, height: int = 70, corner_radius: int | str | None = 10, border_width: int | str | None = 1, bg_color: str | Tuple[str] = "transparent", fg_color: str | Tuple[str] | None = '#FFEE99', border_color: str | Tuple[str] | None = '#A3EA4C', background_corner_colors: Tuple[str | Tuple[str]] | None = ('#3DA13F', '#3DA13F', '#3DA13F', '#3DA13F'), overwrite_preferred_drawing_method: str | None = None, **kwargs):

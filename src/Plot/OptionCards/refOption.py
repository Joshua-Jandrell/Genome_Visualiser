...
class RefOptionCard(PlotOptionCard):
    def __init__(self, master, option_ctrl, option_key: str, option_value=None, width: int = 200, height: int = 70, corner_radius: int | str | None = 10, border_width: int | str | None = 1, bg_color: str | Tuple[str] = "transparent", fg_color: str | Tuple[str] | None = "transparent", border_color: str | Tuple[str] | None = "black", background_corner_colors: Tuple[str | Tuple[str]] | None = ("#29E838", "#E829D8", "#E89829", "#2979E8"), overwrite_preferred_drawing_method: str | None = None, **kwargs):
        ...
        self.t = ctk.CTkLabel(self.content ,text= "This view shows the Reference & Alternate nucleotide sequences at each position.", wraplength= 300)
        self.t.pack()